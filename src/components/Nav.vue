<template>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark navbar-fixed-top">
    <router-link class="navbar-brand" to="/">
      <img alt="HeartBeat" src="../assets/heartbeat.png" height="30">
    </router-link>
    <button
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="Exercises" active-class="active">Exercises</router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="Food" active-class="active">Foods</router-link>
        </li>
        <li class="nav-item">
